...
object DataUtils {
  ...
  def getTimestamp(): Long = {
    val time = DataUtils.getrealTime("yyyyMMddHHmmss")
    DataUtils.funStringToTimeStamp(time, "yyyyMMddHHmmss")
  }
  ...
  def main(args: Array[String]): Unit = {
    //    val arr: Array[String] = DataUtils.getPastHours("2024040912", 2, 10)
